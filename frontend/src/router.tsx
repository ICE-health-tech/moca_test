    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route element={<PrivateRoute roles={['PATIENT']} />}>
          ...
          <Route path="/patient/clinicians" element={<PatientDoctorsPage />} />
          <Route path="/patient/settings" element={<PatientSettingsPage />} />
        </Route>

        <Route element={<PrivateRoute roles={['DOCTOR']} />}>
          <Route path="/clinician" element={<DoctorDashboardPage />} />
          <Route path="/clinician/patients" element={<DoctorPatientsPage />} />
          <Route path="/clinician/reviews/:id" element={<DoctorReviewPage />} />
        </Route>

        <Route element={<PrivateRoute roles={['ADMIN']} />}>
          <Route path="/admin" element={<AdminDashboardPage />} />
          <Route path="/admin/clinicians" element={<AdminDoctorsPage />} />
        </Route>
